...
This directory contains a ready-made Terraform configuration and an example terraform.tfvars file for deploying this module. Refer to the sections below for details on the key settings and their corresponding input variables to deploy your Boundary instance.
